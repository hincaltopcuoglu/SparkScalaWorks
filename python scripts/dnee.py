# -*- coding: utf-8 -*-
"""
Created on Mon Oct 30 20:25:45 2017
...
forecasts = inverse_transform(series, forecasts, scaler, n_test+15)
actual = [row[n_lag:] for row in test]
actual = inverse_transform(series, actual, scaler, n_test+2)
# evaluate forecasts
evaluate_forecasts(actual, forecasts, n_lag, n_test+2)
# plot forecasts
plot_forecasts(series, forecasts, n_test)



a=pd.DataFrame(series.append(forecasts[0]))

a.to_csv("C:\\Users\\Administrator\\Desktop\\ZOB_Share5.csv",sep="\t",float_format='%10.2f')
