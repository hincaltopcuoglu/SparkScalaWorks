...
object MovieSimilarities {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("C:/Users/htopcuoglu/Desktop/SparkScala/ml-100k/u.item").getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val data = sc.textFile("C:/Users/htopcuoglu/Desktop/SparkScala/ml-100k/u.data")
   ...
   // if (args.length > 0) {
     ...
     // val movieID:Int = args(0).toInt
      ...
      println("\nTop 10 similar movies for " + nameDict(3))
      for (result <- results) {
        val sim = result._1
        val pair = result._2
