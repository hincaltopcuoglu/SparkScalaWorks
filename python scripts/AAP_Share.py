# -*- coding: utf-8 -*-
"""
Created on Tue Nov  7 15:17:59 2017
...
predictions = predict_sequences_multiple(regressor,training_set,30,30)


inversed2=sc.inverse_transform(np.array(predictions[14]).reshape(-1, 1))
